...
// Each row also states, in plain numbers: what to aim for (PB pace once
// one exists, else the optional manual target), and once a segment is
// done, what you actually took and the delta between the two.
  ...
  return (
    <div className="pn-roller">
      <div className="pn-roller-status">
        ...
        {currentAim != null && <span className="pn-roller-status-aim">aim {fmt(currentAim, false)}</span>}
      </div>
      <div className="pn-roller-list">
        ...
        {segments.map((s, i) => {
          ...
          const delta = done && actual != null && aim != null ? actual - aim : null;
          return (
            <div
              key={s.id}
            ...
            >
              ...
              <span className="pn-roller-stats">
                {done ? (
                  ...
                  aim != null && <span className="pn-mono pn-roller-aim">{fmt(aim, false)}</span>
                )}
              </span>
            </div>
          );
